...
public class BlueConnect : MonoBehaviour
{
    ...
    public void convertByteToData(string msg)
    {
        ...
        if(binaryText[3] == '1') //Subscribe to Non-Gravity Acceleration
        {
        ...
        if (binaryText[2] == '1') //Subscribe to Gravity Acceleration
        {
        ...
        if (binaryText[1] == '1') //Subscribe to Angular Velocity
        {
        ...
        //Get the Acceleration of the Navigation System
